...
class Game:
    ...
    def game_loop(self):
        while self.playing:
            ...
            if joystickBlueRight.when_pressed and self.player.rect.x < self.window.get_width() - self.player.rect.width:
                self.player.move_right()
            elif joystickBlueLeft.when_pressed and self.player.rect.x > 0:
