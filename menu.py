...
class HTPMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('Bouton joueur 1 bleu', 30, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 50)
            self.game.draw_text('Bouton 1 bleu GAUCHE = Capacity de tir', 30, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 50)
            self.game.draw_text('Bouton 1 bleu DROITE = Capacity speciale', 30, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 50)
            self.game.draw_text('Bouton joueur 2', 30, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 50)
            self.game.draw_text('Bouton 1 rouge GAUCHE = Capacity de tir', 30, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 50)
            self.game.draw_text('Bouton 1 rouge DROITE = Capacity speciale', 30, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 50)
