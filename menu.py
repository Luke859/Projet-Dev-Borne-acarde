    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            if self.game.START_KEY or self.game.BACK_KEY:
                ...
                self.run_display = False
            self.game.display.fill(self.game.BLACK)
            self.game.draw_text('Joystick :', 30, self.game.DISPLAY_W / 2 - 100, self.game.DISPLAY_H / 2 - 50)
            self.game.draw_text('↑ Haut', 15, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 0)
            self.game.draw_text('↓ Bas', 15, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 + 20)
            self.game.draw_text('→ Droite', 15, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 + 40)
            ...
            self.game.draw_text('Bouton DROITE = Capacity speciale', 15, self.game.DISPLAY_W / 2 - 75, self.game.DISPLAY_H / 2 + 0)
