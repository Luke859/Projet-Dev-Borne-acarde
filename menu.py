...
class HTPMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('Bouton GAUCHE = Capacity de tir', 30, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 - 50)
            self.game.draw_text('Bouton DROITE = Capacity speciale', 30, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 + 0)
